...
if("TRUE" STREQUAL "TRUE")
  set(cartesian_control_SOURCE_PREFIX /home/hamid/Desktop/project4/catkin_ws/src/cartesian_control)
  set(cartesian_control_DEVEL_PREFIX /home/hamid/Desktop/project4/catkin_ws/devel/.private/cartesian_control)
  ...
  set(cartesian_control_INSTALL_PREFIX /home/hamid/Desktop/project4/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cartesian_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'cartesian_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hamid/Desktop/project4/catkin_ws/src/cartesian_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hamid/Desktop/project4/catkin_ws/devel/.private/cartesian_control/lib;/home/hamid/Desktop/project4/catkin_ws/devel/lib;/home/hamid/Desktop/project3/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cartesian_control_dep}_FOUND)
      find_package(${cartesian_control_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cartesian_control_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
